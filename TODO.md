...
- [x] Step 2: User runs `install.bat` for setup (venv, deps, ollama model pull) - Progress: pip completed (cancelled but deps installed), model pull 23% at 1.7MB/s (~15min left)
